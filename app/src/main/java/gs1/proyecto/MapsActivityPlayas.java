...
public class MapsActivityPlayas extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            Toast nullToast = Toast.makeText(getApplicationContext(),
                    "NullPointer", Toast.LENGTH_SHORT);
            nullToast.show();
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mpConfital = googleMap.addMarker(new MarkerOptions().position(pConfital).title("Playa del Confital").icon(BitmapDescriptorFactory.fromResource(R.drawable.beachgreen)));
                //.icon(BitmapDescriptorFactory.fromResource(R.drawable.beach)));
        ...
        mpCicer = googleMap.addMarker(new MarkerOptions().position(pCicer).title("Playa la Cícer").icon(BitmapDescriptorFactory.fromResource(R.drawable.beachred)));
        ...
        mpPenavieja = googleMap.addMarker(new MarkerOptions().position(pPenavieja).title("Playa Peña de la Vieja").icon(BitmapDescriptorFactory.fromResource(R.drawable.beachgreen)));
        ...
        mpChica = googleMap.addMarker(new MarkerOptions().position(pChica).title("Playa Chica").icon(BitmapDescriptorFactory.fromResource(R.drawable.beachblack)));
        ...
        mpGrande = googleMap.addMarker(new MarkerOptions().position(pGrande).title("Playa Grande").icon(BitmapDescriptorFactory.fromResource(R.drawable.beachgreen)));
        ...
        mpPuntilla = googleMap.addMarker(new MarkerOptions().position(pPuntilla).title("Playa la Puntilla").icon(BitmapDescriptorFactory.fromResource(R.drawable.beachorange)));
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        if (marker.equals(mpConfital)) {
            Toast.makeText(this, "NIVEL verde, TODO PERFECTO", Toast.LENGTH_SHORT).show();
        }
        return false;
